...
@section('content')
    <div style="text-align: center">
        <h1 style="margin-bottom: 2%">You are about to give a welcome bag AND tshirt to:</h1>
        ...
        <a id="confirm" href="{{route('oc.doGiveWelcomeBag',$user->id)}}" class="btn btn-success">Confirm</a>
        <a href="{{route('oc.welcomeBags')}}" class="btn btn-danger">Back</a>
    </div>
@endsection
